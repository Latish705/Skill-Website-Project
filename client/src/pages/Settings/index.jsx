        ...
        <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
          <div className="flex md:flex-1 md:flex-col flex-row md:gap-10 items-start justify-between md:px-5 w-3/5 md:w-full">
            ...
            <div className="flex flex-1 flex-col items-start justify-start w-full">
                ...
                <div className="flex sm:flex-col flex-row gap-[30px] items-center justify-between w-full">
                  ...
                  <div className="flex flex-col gap-6 items-start justify-start">
                    ...
                    <div className="flex flex-row gap-5 items-center justify-between w-full">
                      <Button
                        className="cursor-pointer font-bold font-inter min-w-[180px] py-[21px] rounded-[29px] text-center text-sm"
                      ...
                      <Button
                        className="cursor-pointer flex items-center justify-center min-w-[180px] pr-[35px] py-[22px]"
                        leftIcon={
                          <Img
                        ...
                        variant="outline"
                      >
                        <div className="!text-red-A200 font-bold font-sfprodisplay sm:pr-5 text-left text-sm">
                          Delete
                        </div>
                      </Button>
                    </div>
                ...
                <div className="md:gap-5 gap-[30px] grid md:grid-cols-1 grid-cols-2 justify-center min-h-[auto] w-full">
                  ...
                  <div className="flex flex-1 flex-col gap-3.5 items-start justify-start w-full">
                    ...
                    <Input
                      ...
                      className="font-medium p-0 placeholder:text-gray-500 text-left text-sm w-full"
                      wrapClassName="flex pb-3.5 pl-[15px] pt-[19px] w-full"
                      suffix={
                        <Img
                  ...
                  <div className="flex flex-1 flex-col gap-[15px] items-start justify-start w-full">
                    ...
                    <Input
                      ...
                      className="font-medium p-0 placeholder:text-gray-500 text-left text-sm w-full"
                      wrapClassName="flex pb-[13px] pl-[15px] pt-[18px] w-full"
                      suffix={
                        <Img
                          className="h-[18px] ml-[35px] mr-[15px] my-[15px]"
              ...
              <Button
                className="cursor-pointer font-bold min-w-[180px] mt-16 py-[21px] rounded-[29px] text-center text-sm"
                color="green_400"
                variant="fill"
              >
                Save Changes
