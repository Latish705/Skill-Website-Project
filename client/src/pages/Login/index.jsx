      ...
      <div className="bg-gray-100 flex font-inter mx-auto relative w-full">
        ...
        >
          <div className="flex flex-col items-center justify-start my-[130px] w-full">
            ...
            <Button
              className="common-pointer cursor-pointer font-bold min-w-[220px] mt-[30px] py-[22px] rounded-[29px] text-center text-sm"
        ...
        <div className="flex md:flex-col flex-row gap-2.5 items-center justify-between ml-[-45px] my-auto md:px-5 w-[46%] z-[1]">
          ...
          <div className="bg-white-A700 flex flex-col justify-start p-[100px] md:px-10 sm:px-5 rounded-bl-[32px] rounded-tl-[32px]">
            ...
            <File className="flex flex-col gap-[34px] items-center justify-start md:ml-[0] ml-[37px] mr-[53px] mt-[60px] pt-[3px] w-4/5 md:w-full" />
            <Text
            ...
            <div className="flex flex-col gap-[34px] justify-start mb-1 md:ml-[0] ml-[37px] mr-[53px] mt-[33px] w-4/5 md:w-full">
              ...
              <div className="flex flex-col gap-5 items-center justify-start w-full">
                <Button
                  className="cursor-pointer flex items-center justify-center min-w-[350px] pr-[35px] py-[22px] rounded-[29px]"
                  leftIcon={
                    <Img
                ...
                <Button
                  className="cursor-pointer flex items-center justify-center min-w-[350px] pr-[35px] py-[21px] rounded-[29px]"
                  leftIcon={
                    <Img
